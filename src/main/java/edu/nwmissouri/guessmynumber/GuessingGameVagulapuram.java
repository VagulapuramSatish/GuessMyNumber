 ...
 */
public class GuessingGameVagulapuram {
    ...
    public static void main(String[] args) {
        ...
        while (userAnswer != secretNumber) {
            ...
            JOptionPane.showMessageDialog(null, "" + calculateMesssage(userAnswer, secretNumber, count));
            count++;
        }
    }

    // TODO: Refactor / Rename determineGuess to calculateMessage
    public static String calculateMesssage(int userAnswer, int computerNumber, int count) {
